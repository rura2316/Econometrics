...
```{r}
experiment<-function(){
  zaid1=rollDice(1) #fiksuojame pirmo žaidėjo taškų skaičius
  zaid2=rollDice(2) #fiksuojame antro žaidėjo taškų skaičius
    while(zaid1==zaid2){ #jei žaidėjų taškų skaičius sutampa ekspermentą kartojame, kol taškų skaičius skirsis ir galėsim nustatyti laimėtoją
    zaid1=rollDice(1)
    zaid2=rollDice(2)
  }
  (zaid1>zaid2)
...
Simuliacija:
```{r}
sim = replicate(10000, experiment()) #kartojame ekspermentą 10000kartų
```
